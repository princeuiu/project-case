...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon white edit"></i><span class="break"></span><?php echo __('Generated Invoices List'); ?></h2>
        </div>
        <div class="box-content">
            <?php
            $items = $this_case['Invoice'];
            if (!empty($items)):
                ?>
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    <thead>
                        <?php echo $this->Html->tableHeaders(array('Ref. Number', 'Amount', 'Status', 'Actions')); ?>
                    </thead>   
                    <tbody>
                        <?php foreach ($items as $item): ?>
                            <tr>
                                ...
                                <td><span class="label <?php
                                    ...
                                    ?>"><?php echo h($item['status']); ?></span></td>
                                <td class="center">
                                    <a class="btn btn-info" target="_blank" title="Export Pdf" href="<?php echo $this->Html->url(array('controller' => 'invoices', 'action' => 'detail', $item['id'] . '.pdf')); ?>">
...
<?php else: ?>
                <div class="alert alert-block ">
                    ...
                    <p>No Invoice has been generated yet for this File.</p>
                </div>
<?php endif; ?>        
        </div>
    </div><!--/span-->
