                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <select id="TaskFollower" multiple data-rel="chosen" name="data[Task][follower][]">
                                 <?php foreach($users as $userId => $userName): ?>
                                 <option value="<?php echo $userId; ?>" <?php if(in_array($userId, $followers)){ echo "selected"; }?>><?php echo $userName; ?></option>
                                 <?php endforeach; ?>
                              </select>
                            <?php
